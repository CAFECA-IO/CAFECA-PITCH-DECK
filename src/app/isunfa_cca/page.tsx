...
export default function CCASlideBrowser() {
  ...
  const slideTitles: { [key: number]: string } = {
    1: '從記帳到記碳－迎戰國內碳費與減碳目標的 AI 方案',
    2: '挑戰與痛點 —— 企業碳盤查與碳費申報的實務困境',
    3: '核心解法 —— 財務與碳排雙軌並進的 AI 引擎',
    4: 'AI 財碳雙軌轉型：確保碳數據與財務數據的一致性',
    5: '克服幻覺 —— 導入駕馭工程確保數據合規',
    6: '步驟一：AI 自動記帳與活動數據 (Activity Data) 辨識',
    7: '步驟一檢核：結構化知識注入與盤查邊界評估',
    8: '步驟二：碳排係數 (Emission Factor) 精準配對與國家庫接軌',
    9: '步驟二檢核：碳係數精準度與適用性自我評估',
    10: '步驟三：一鍵生成符合氣候變遷署規範之碳盤查報告',
    11: '步驟三檢核：報告完整性與審計軌跡 (Audit Trail) 自評',
    12: '終極產出 —— 打造透明、可溯源的數位產品護照與碳履歷',
    13: '願景與結語 —— AI 賦能，協助政府與企業共創淨零未來',
    14: '專屬推薦 —— 立即體驗 AI 碳會計合規服務',
  };
    ...
    <div className="flex flex-col h-screen bg-slate-50 text-slate-900 overflow-hidden font-sans">
      <div className="h-14 border-b border-slate-200 flex items-center justify-between px-4 bg-white z-20 flex-shrink-0">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <div>
            <h1 className="text-sm font-bold text-sky-950">iSunFA 氣候變遷署</h1>
        ...
        <div className="flex items-center gap-3">
          <Link href="/isunfa_cca/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/isunfa_cca/${currentSlide}`} target="_blank" className="hidden md:block">
