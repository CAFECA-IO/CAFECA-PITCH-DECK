...
export default function CCASlide2() {
  return (
        ...
        <div className="flex-1 px-16 z-10 grid grid-cols-2 gap-12 pb-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-6">
              台灣碳費徵收正式上路，企業若無法精準交代碳排數據並通過第三方查證，將面臨極大的法遵風險及碳費成本，甚至影響減碳目標的達成。
            </p>
            <div className="bg-rose-50 border-l-4 border-rose-500 p-6 rounded-r-lg">
              ...
              <p className="text-rose-700">「記帳與記碳分離」，導致財務數據與碳盤查數據脫鉤，難以應付氣候變遷署嚴格的數據一致性與可溯源性要求。</p>
            </div>
          </div>
