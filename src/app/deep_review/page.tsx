...
import DeepReviewSlide1 from '@/app/deep_review/1/page';
import DeepReviewSlide2 from '@/app/deep_review/2/page';
import DeepReviewSlide3 from '@/app/deep_review/3/page';
import DeepReviewSlide4 from '@/app/deep_review/4/page';
import DeepReviewSlide5 from '@/app/deep_review/5/page';
import DeepReviewSlide6 from '@/app/deep_review/6/page';
import DeepReviewSlide7 from '@/app/deep_review/7/page';
import DeepReviewSlide8 from '@/app/deep_review/8/page';
import DeepReviewSlide9 from '@/app/deep_review/9/page';
import DeepReviewSlide10 from '@/app/deep_review/10/page';
import DeepReviewSlide11 from '@/app/deep_review/11/page';
import DeepReviewSlide12 from '@/app/deep_review/12/page';
import DeepReviewSlide13 from '@/app/deep_review/13/page';
import DeepReviewSlide14 from '@/app/deep_review/14/page';
import DeepReviewSlide15 from '@/app/deep_review/15/page';
import DeepReviewSlide16 from '@/app/deep_review/16/page';
import DeepReviewSlide17 from '@/app/deep_review/17/page';
import DeepReviewSlide18 from '@/app/deep_review/18/page';
import DeepReviewSlide19 from '@/app/deep_review/19/page';
import DeepReviewSlide20 from '@/app/deep_review/20/page';
import DeepReviewSlide21 from '@/app/deep_review/21/page';
    ...
    <div className="flex flex-col h-screen bg-neutral-900 text-white overflow-hidden">
      ...
      <div className="h-14 border-b border-neutral-800 flex items-center justify-between px-4 bg-neutral-900 z-20 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          <Link href="/deep_review/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/deep_review/${currentSlide}`} target="_blank" className="hidden md:block">
