...
import IsunfaAsusSlide1 from '@/app/isunfa_asus/1/page';
import IsunfaAsusSlide2 from '@/app/isunfa_asus/2/page';
import IsunfaAsusSlide3 from '@/app/isunfa_asus/3/page';
import IsunfaAsusSlide4 from '@/app/isunfa_asus/4/page';
import IsunfaAsusSlide5 from '@/app/isunfa_asus/5/page';
import IsunfaAsusSlide6 from '@/app/isunfa_asus/6/page';
import IsunfaAsusSlide7 from '@/app/isunfa_asus/7/page';
import IsunfaAsusSlide8 from '@/app/isunfa_asus/8/page';
import IsunfaAsusSlide9 from '@/app/isunfa_asus/9/page';
import IsunfaAsusSlide10 from '@/app/isunfa_asus/10/page';
import IsunfaAsusSlide11 from '@/app/isunfa_asus/11/page';
import IsunfaAsusSlide12 from '@/app/isunfa_asus/12/page';
import IsunfaAsusSlide13 from '@/app/isunfa_asus/13/page';

export default function IsunfaAsusSlideBrowser() {
  const [currentSlide, setCurrentSlide] = useState(1);
  const totalSlides = 13;
  const containerRef = useRef<HTMLDivElement>(null);
  const [scale, setScale] = useState(1);

  // Info: (20260715 - Luphia) Dynamic scaling logic for mobile preview
  const [mobileScale, setMobileScale] = useState(0.3);

  useEffect(() => {
    const handleResize = () => {
      // Info: (20260715 - Luphia) Desktop Preview Scaling Calc
      ...
      // Info: (20260715 - Luphia) Mobile List Scaling Calc
  ...
  // Info: (20260715 - Luphia) Slide Components Mapping
  const SlideComponents: { [key: number]: React.ComponentType } = {
    ...
    8: IsunfaAsusSlide8,
    9: IsunfaAsusSlide9,
    10: IsunfaAsusSlide10,
    11: IsunfaAsusSlide11,
    12: IsunfaAsusSlide12,
    13: IsunfaAsusSlide13,
  };

  const CurrentSlideComponent = SlideComponents[currentSlide];

  const slideTitles: { [key: number]: string } = {
    1: '封面：CAFECA × ASUS EIP',
    2: '① 廠商背景與定位',
    3: '② 台灣市場發展現況',
    4: '③ 海外市場營運計畫與能量',
    5: '④ 服務對象、痛點與核心功能',
  ...
  // Info: (20260715 - Luphia) Keyboard navigation
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 text-slate-800 overflow-hidden font-sans">
      ...
      {/* Info: (20260715 - Luphia) Universal Header */}
      <div className="h-14 border-b border-slate-200 flex items-center justify-between px-4 bg-white/80 backdrop-blur-md z-20 flex-shrink-0">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <div>
            <h1 className="text-sm font-bold text-slate-800 tracking-wide">卡菲卡金融科技 · iSunFA × ASUS EIP 整合提案</h1>
            <p className="text-xs text-slate-500">ASUS ExpertHub 軟體方案提案簡報 • 2026</p>
          </div>
        </Link>

        {/* Info: (20260715 - Luphia) Desktop Controls */}
        ...
        {/* Info: (20260715 - Luphia) Actions */}
        <div className="flex items-center gap-3">
          <Link href="/isunfa_asus/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/isunfa_asus/${currentSlide}`} target="_blank" className="hidden md:block">
      ...
      {/* Info: (20260715 - Luphia) Mobile View */}
      <div
      ...
      {/* Info: (20260715 - Luphia) Desktop Layout */}
      <div className="hidden md:flex flex-1 overflow-hidden">
        <div className="flex-1 flex overflow-hidden">
          {/* Info: (20260715 - Luphia) Preview Area */}
          ...
          {/* Info: (20260715 - Luphia) Side Navigator */}
