...
export default function DPPSlide22() {
  return (
      ...
      <div className="w-[1280px] h-[720px] bg-neutral-900 relative overflow-hidden shadow-2xl flex flex-col border border-gray-800 rounded-xl">
        ...
        <div className="flex-1 flex flex-col p-16 z-10">
          <div className="mb-12">
            ...
            <h2 className="text-5xl font-bold text-white mt-4 tracking-wide leading-tight">iSunFA 實戰 Step 3：AI 編寫循環經濟指南</h2>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="bg-neutral-800/30 backdrop-blur-md border border-neutral-700/50 p-10 rounded-2xl shadow-xl max-w-5xl">
              <div className="space-y-6">
                <p className="text-xl md:text-2xl text-gray-300 leading-relaxed font-light">根據輸入的 BOM 表材質，iSunFA 內建的環境工程大數據模型會進行交叉比對。自動產出符合歐盟 WEEE 指令的「回收方法」：包含材料可回收率分析、拆解步驟建議及有害物質聲明。</p>\n
              </div>
            </div>
          </div>
        </div>
