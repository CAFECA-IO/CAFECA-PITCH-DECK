...
export default function DPPSlide4() {
  return (
      ...
      <div className="w-[1280px] h-[720px] bg-neutral-900 relative overflow-hidden shadow-2xl flex flex-col border border-gray-800 rounded-xl">
        ...
        <div className="flex-1 flex flex-col p-16 z-10">
          <div className="mb-12">
            ...
            <h2 className="text-5xl font-bold text-white mt-4 tracking-wide leading-tight">危機即轉機：DPP 帶來的商業戰略優勢</h2>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="bg-neutral-800/30 backdrop-blur-md border border-neutral-700/50 p-10 rounded-2xl shadow-xl max-w-5xl">
              <div className="space-y-6">
                <p className="text-xl md:text-2xl text-gray-300 leading-relaxed font-light">• 獲取綠色溢價 (Green Premium)： 數據透明的低碳產品，能為買方降低合規風險，從而獲得更高的議價空間。
• 優化融資條件： 符合高標準 ESG 確信的企業，更容易取得綠色金融的低利貸款。</p>\n
              </div>
            </div>
          </div>
        </div>
