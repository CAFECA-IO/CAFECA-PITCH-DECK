...
export default function CafecaIsunfaPrint() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`CAFECA_ISUNFA_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'CAFECA_ISUNFA_Pitch_Deck.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-white min-h-screen">
      ...
      <div className="slide-page"><CafecaIsunfaSlide13 /></div>
      <div className="slide-page"><CafecaIsunfaSlide14 /></div>
      <div className="slide-page"><CafecaIsunfaSlide15 /></div>
      <div className="slide-page"><CafecaIsunfaSlide16 /></div>
      <div className="slide-page"><CafecaIsunfaSlide17 /></div>
    </div>
  );
}
