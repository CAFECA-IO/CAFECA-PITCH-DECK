...
import CafecaIsunfaSlide1 from '@/app/cafeca_tnta/1/page';
import CafecaIsunfaSlide2 from '@/app/cafeca_tnta/2/page';
import CafecaIsunfaSlide3 from '@/app/cafeca_tnta/3/page';
import CafecaIsunfaSlide4 from '@/app/cafeca_tnta/4/page';
import CafecaIsunfaSlide5 from '@/app/cafeca_tnta/5/page';
import CafecaIsunfaSlide6 from '@/app/cafeca_tnta/6/page';
import CafecaIsunfaSlide7 from '@/app/cafeca_tnta/7/page';
import CafecaIsunfaSlide8 from '@/app/cafeca_tnta/8/page';
import CafecaIsunfaSlide9 from '@/app/cafeca_tnta/9/page';
import CafecaIsunfaSlide10 from '@/app/cafeca_tnta/10/page';
import CafecaIsunfaSlide11 from '@/app/cafeca_tnta/11/page';
import CafecaIsunfaSlide12 from '@/app/cafeca_tnta/12/page';
...
export default function CafecaIsunfaSlideBrowser() {
  ...
  // Info: (20260609 - Luphia) Dynamic scaling logic for mobile preview
  const [mobileScale, setMobileScale] = useState(0.3);

  useEffect(() => {
    const handleResize = () => {
      // Info: (20260609 - Luphia) Desktop Preview Scaling Calc
      ...
      // Info: (20260609 - Luphia) Mobile List Scaling Calc
  ...
  // Info: (20260609 - Luphia) Slide Components Mapping
  ...
  // Info: (20260609 - Luphia) Keyboard navigation
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-screen bg-neutral-900 text-white overflow-hidden">
      ...
      {/* Info: (20260609 - Luphia) Universal Header */}
      <div className="h-14 border-b border-neutral-800 flex items-center justify-between px-4 bg-neutral-900 z-20 flex-shrink-0">
        ...
        {/* Info: (20260609 - Luphia) Desktop Controls */}
        ...
        {/* Info: (20260609 - Luphia) Actions */}
        <div className="flex items-center gap-3">
          <Link href="/cafeca_tnta/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/cafeca_tnta/${currentSlide}`} target="_blank" className="hidden md:block">
      ...
      {/* Info: (20260609 - Luphia) Mobile View */}
      <div
      ...
      {/* Info: (20260609 - Luphia) Desktop Layout */}
      <div className="hidden md:flex flex-1 overflow-hidden">
        <div className="flex-1 flex overflow-hidden">
          {/* Info: (20260609 - Luphia) Preview Area */}
          ...
          {/* Info: (20260609 - Luphia) Side Navigator */}
