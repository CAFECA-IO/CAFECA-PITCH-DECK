...
export default function SinoBeeSlide6() {
  return (
    <div className="w-[1280px] h-[720px] bg-neutral-900 relative overflow-hidden flex flex-col justify-center border border-neutral-800 text-white">
      ...
      <div className="relative z-10 px-24 h-full flex flex-col justify-center">
        ...
        <h2 className="text-5xl font-extrabold text-white leading-tight mb-12">
          技能生態系：Nectar Store
          <span className="block text-2xl text-amber-500/80 font-light mt-3">The App Store for AI Swarms</span>
        </h2>
        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="bg-neutral-800/50 rounded-3xl p-8 border border-neutral-700 flex items-start gap-6 hover:border-amber-500/50 transition-colors group">
              <div className="p-4 bg-amber-500/10 rounded-2xl text-amber-500 group-hover:bg-amber-500 group-hover:text-white transition-colors shrink-0">
                <Box size={28} />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white mb-2">動態擴充庫 (Dynamic Repository)</h3>
            ...
            <div className="bg-neutral-800/50 rounded-3xl p-8 border border-neutral-700 flex items-start gap-6 hover:border-sky-500/50 transition-colors group">
              <div className="p-4 bg-sky-500/10 rounded-2xl text-sky-400 group-hover:bg-sky-500 group-hover:text-white transition-colors shrink-0">
                <DownloadCloud size={28} />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white mb-2">隨插即用 (Plug & Play)</h3>
                <p className="text-slate-400 leading-relaxed font-light">
            ...
            <div className="bg-neutral-800/50 rounded-3xl p-8 border border-neutral-700 flex items-start gap-6 hover:border-emerald-500/50 transition-colors group">
              <div className="p-4 bg-emerald-500/10 rounded-2xl text-emerald-400 group-hover:bg-emerald-500 group-hover:text-white transition-colors shrink-0">
                <Coins size={28} />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white mb-2">開發者共創分潤 (Creator Economy)</h3>
                <p className="text-slate-400 leading-relaxed font-light">
