...
export default function NetZeroFactoryPrint() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`NetZeroFactory_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'NetZeroFactory_Slides_PNG.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-slate-100 min-h-screen">
      ...
      <div className="slide-page"><NetZeroFactorySlide1 /></div>
      <div className="slide-page"><NetZeroFactorySlide2 /></div>
      <div className="slide-page"><NetZeroFactorySlide3 /></div>
      <div className="slide-page"><NetZeroFactorySlide4 /></div>
      <div className="slide-page"><NetZeroFactorySlide5 /></div>
      <div className="slide-page"><NetZeroFactorySlide6 /></div>
      <div className="slide-page"><NetZeroFactorySlide7 /></div>
      <div className="slide-page"><NetZeroFactorySlide8 /></div>
      <div className="slide-page"><NetZeroFactorySlide9 /></div>
      <div className="slide-page"><NetZeroFactorySlide10 /></div>
      <div className="slide-page"><NetZeroFactorySlide11 /></div>
    </div>
  );
}
