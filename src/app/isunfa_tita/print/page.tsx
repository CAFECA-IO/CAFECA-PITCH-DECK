...
export default function TITAPrint() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`TITA_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'TITA_Slides_PNG.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-slate-100 min-h-screen">
      ...
      <div className="slide-page"><TITASlide1 /></div>
      <div className="slide-page"><TITASlide2 /></div>
      <div className="slide-page"><TITASlide3 /></div>
      <div className="slide-page"><TITASlide4 /></div>
      <div className="slide-page"><TITASlide5 /></div>
      <div className="slide-page"><TITASlide6 /></div>
      <div className="slide-page"><TITASlide7 /></div>
      <div className="slide-page"><TITASlide8 /></div>
      <div className="slide-page"><TITASlide9 /></div>
      <div className="slide-page"><TITASlide10 /></div>
      <div className="slide-page"><TITASlide11 /></div>
      <div className="slide-page"><TITASlide12 /></div>
      <div className="slide-page"><TITASlide13 /></div>
      <div className="slide-page"><TITASlide14 /></div>
    </div>
  );
}
