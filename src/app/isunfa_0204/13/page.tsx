...
export default function iSunFASlide13() {
  return (
    <div className="min-h-screen w-full bg-slate-50 flex items-center justify-center p-4 font-sans">
      <div className="w-[1280px] h-[720px] bg-white relative overflow-hidden shadow-2xl flex flex-col items-center border border-slate-200 text-slate-900">
        ...
        {/* Info: (20260701 - Luphia) Background Effects */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[20%] left-[20%] w-[40%] h-[40%] bg-orange-100 blur-[100px] rounded-full opacity-60" />
        ...
        <div className="z-10 w-full max-w-6xl px-12 flex flex-col h-full py-12">
          ...
          {/* Info: (20260701 - Luphia) Title Section */}
          <div className="mb-8 text-center bg-white/50 backdrop-blur-sm py-4 rounded-3xl">
            <div className="flex items-center justify-center gap-3 text-orange-600 mb-2">
              <div className="px-3 py-1 border border-orange-200 rounded-full text-[10px] font-bold tracking-[0.2em] bg-orange-50 uppercase">Success Story</div>
            </div>
          ...
          {/* Info: (20260701 - Luphia) Content Grid */}
          <div className="grid grid-cols-3 gap-6 flex-1 drop-shadow-sm">

            {/* Info: (20260701 - Luphia) Column 1: Challenges */}
            ...
            {/* Info: (20260701 - Luphia) Column 2: Solutions */}
            ...
            {/* Info: (20260701 - Luphia) Column 3: Values */}
            <div className="bg-white border border-orange-100 p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col group hover:border-orange-300 hover:shadow-[0_8px_30px_rgb(249,115,22,0.1)] transition-all z-20">
              ...
              <ul className="space-y-3 text-xs text-slate-600 flex-1">
                <li className="flex items-center gap-3 bg-slate-50 p-3 rounded-xl border border-slate-100 group-hover:bg-orange-50/50 group-hover:border-orange-100 transition-colors">
