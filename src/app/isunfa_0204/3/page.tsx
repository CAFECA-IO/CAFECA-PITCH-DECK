      ...
      <div className="w-[1280px] h-[720px] bg-neutral-950 relative overflow-hidden shadow-2xl flex flex-col items-center justify-center border border-neutral-800 text-white">
        ...
        <div className="z-10 w-full max-w-6xl px-12 flex flex-col h-full py-16">
          ...
          <div className="mb-16 space-y-2">
            <h2 className="text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-200 to-orange-500">
              戰略核心價值
            </h2>
          ...
          <div className="grid grid-cols-3 gap-8 flex-1 items-start">
            ...
            <div className="group relative bg-neutral-900/40 border border-white/10 p-8 rounded-3xl h-full backdrop-blur-xl hover:border-orange-500/50 transition-all duration-500">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-orange-300">接軌世界規範</h3>
              <p className="text-neutral-400 leading-relaxed mb-6">
                支援<span className="text-orange-400 font-medium">美國、歐盟、聯合國、臺灣</span>碳排放係數庫，符合國際碳盤查與會計準則，數據精準、接軌國際
              </p>
              <div className="inline-flex items-center px-3 py-1 bg-orange-500/20 border border-orange-500/30 rounded-full">
                <span className="text-xs text-orange-400 font-medium">立足台灣，放眼全球</span>
              </div>
            </div>
            ...
            <div className="group relative bg-neutral-900/40 border border-white/10 p-8 rounded-3xl h-full backdrop-blur-xl hover:border-orange-500/50 transition-all duration-500">
              <div className="w-12 h-12 bg-orange-500/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Cpu className="text-orange-400 w-7 h-7" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-orange-300">智能決策賦能</h3>
              <p className="text-neutral-400 leading-relaxed mb-6">
                導入 AI 碳預測模型，實時監控排碳熱點，<span className="text-orange-400 font-medium">大幅縮減繁瑣人力作業流程</span>，由「事後盤查」轉向「事前精算」的戰略轉型。
              </p>
            ...
            <div className="group relative bg-orange-500/[0.03] border border-orange-500/20 p-8 rounded-3xl h-full backdrop-blur-xl hover:border-orange-500/50 transition-all duration-500 overflow-hidden">
              {/* Info: (20260212 - Luphia) 裝飾性背景效果 */}
              <div className="absolute -top-12 -right-12 w-24 h-24 bg-orange-500/10 blur-3xl group-hover:bg-orange-500/20 transition-colors" />
              ...
              <div className="space-y-3">
                <div className="flex items-end gap-2">
                  <span className="text-4xl font-black text-orange-400">83%</span>
                  <span className="text-sm text-orange-500/80 mb-1 font-bold">碳費極大化減免</span>
                </div>
                <div className="h-1 w-full bg-neutral-800 rounded-full overflow-hidden">
                  <div className="h-full bg-orange-500 w-[83%] rounded-full shadow-[0_0_8px_rgba(249,115,22,0.5)]" />
                </div>
              </div>
            </div>
