      ...
      <div className="w-[1280px] h-[720px] bg-neutral-950 relative overflow-hidden shadow-2xl flex flex-col items-center justify-center border border-neutral-800 text-white">
        ...
        <div className="z-10 w-full max-w-6xl px-12 flex flex-col h-full py-12">
          ...
          <div className="grid grid-cols-2 gap-12 flex-1 items-center px-8">
            ...
            <div className="group relative bg-neutral-900/40 border border-white/10 p-8 rounded-3xl h-full backdrop-blur-xl hover:border-orange-500/50 hover:bg-neutral-900/60 transition-all duration-500 flex flex-col">
              <div className="flex items-center gap-6 mb-8">
                <div className="w-20 h-20 bg-orange-500/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-[0_0_20px_rgba(249,115,22,0.1)]">
                  <NotebookPen className="text-orange-400 w-10 h-10" />
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-white mb-1 group-hover:text-orange-300 transition-colors">自動記帳</h3>
                  <span className="text-orange-500 font-mono text-sm">(AI Bookkeeping)</span>
                </div>
              </div>
              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-400 leading-relaxed">
                      <span className="text-orange-400 font-bold">節省 70% 資料登打時間</span>，讓財務人員專注於審核與分析。
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 flex gap-4 text-xs text-neutral-500 font-mono">
                ...
                <div className="flex items-center gap-1.5">
                  <HandCoins className="w-3 h-3 text-orange-500/70" />
            ...
            <div className="group relative bg-neutral-900/40 border border-white/10 p-8 rounded-3xl h-full backdrop-blur-xl hover:border-orange-500/50 hover:bg-neutral-900/60 transition-all duration-500 flex flex-col">
              <div className="flex items-center gap-6 mb-8">
                <div className="w-20 h-20 bg-orange-500/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-[0_0_20px_rgba(249,115,22,0.1)]">
                  <MonitorCheck className="text-orange-400 w-10 h-10" />
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-white mb-1 group-hover:text-orange-300 transition-colors">會計報表</h3>
                  <span className="text-orange-500 font-mono text-sm">(Financial Reports)</span>
                </div>
              </div>
              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-white mb-1">效益：</h4>
                    <p className="text-neutral-400 leading-relaxed">
                      決策不再憑感覺，隨時掌握公司現金流與獲利能力，<span className="text-orange-400 font-bold">滿足銀行融資需求</span>。
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 flex gap-4 text-xs text-neutral-500 font-mono">
                <div className="flex items-center gap-1.5">
                  <FileText className="w-3 h-3 text-orange-500/70" />
