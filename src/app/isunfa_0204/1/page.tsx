...
export default function iSunFASlide1() {
  return (
    <div className="min-h-screen w-full bg-neutral-50 flex items-center justify-center p-4">
      <div className="w-[1280px] h-[720px] bg-white relative overflow-hidden shadow-2xl flex flex-col items-center justify-center border border-gray-200">
        ...
        {/* Info: (20260212 - Luphia) Background Gradients - Orange Theme */}
        <div
          className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl pointer-events-none"
          aria-hidden="true"
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[70rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-orange-500 to-amber-400 opacity-20"
            style={{
              clipPath:
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[70rem] -translate-x-1/2 bg-gradient-to-tr from-orange-600 to-amber-500 opacity-20"
            style={{
              clipPath:
                'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
            }}
        ...
        <div className="z-10 text-center space-y-8 animate-fade-in-up">
          ...
          <div className="mb-12">
            <span className="text-orange-700 font-bold tracking-[0.25em] text-sm md:text-base border border-orange-200 px-6 py-2 rounded-full uppercase bg-orange-50/50 backdrop-blur-sm shadow-sm">
              iSunFA
            </span>
          </div>

          {/* Info: (20260212 - Luphia) Main Title */}
          <h1 className="text-8xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-orange-900 via-orange-700 to-amber-600 leading-[1.1] drop-shadow-sm pb-4 mx-auto max-w-7xl">
            陽光智能會計
            <br />
            <span className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-700 to-amber-600 mt-4 block">
              解決財務會計、碳盤查與 ESG 大小事
            </span>
          </h1>
