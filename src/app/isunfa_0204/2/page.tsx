...
export default function iSunFASlide2() {
  return (
    <div className="min-h-screen w-full bg-neutral-900 flex items-center justify-center p-4">
      <div className="w-[1280px] h-[720px] bg-neutral-900 relative overflow-hidden shadow-2xl flex flex-col items-center justify-center border border-neutral-800 text-white">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-orange-500/20 rounded-full animate-[spin_60s_linear_infinite]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-orange-500/10 rounded-full animate-[spin_40s_linear_infinite_reverse]" />
        ...
        <div className="z-10 text-center space-y-12 animate-fade-in-up">
          ...
          <h1 className="text-8xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-300 to-amber-400 drop-shadow-[0_0_30px_rgba(251,146,60,0.3)]">
            領航淨零，智算未來
          </h1>

          {/* Info: (20260212 - Luphia) English Slogan */}
          <p className="text-4xl font-light tracking-[0.1em] text-orange-100/80 font-mono">
