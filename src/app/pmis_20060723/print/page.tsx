...
export default function Pmis20060723Print() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`PMIS_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'PMIS_Pitch_Deck.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-white min-h-screen">
      ...
      <div className="slide-page"><Pmis20060723Slide1 /></div>
      <div className="slide-page"><Pmis20060723Slide2 /></div>
      <div className="slide-page"><Pmis20060723Slide3 /></div>
      <div className="slide-page"><Pmis20060723Slide4 /></div>
      <div className="slide-page"><Pmis20060723Slide5 /></div>
      <div className="slide-page"><Pmis20060723Slide6 /></div>
      <div className="slide-page"><Pmis20060723Slide7 /></div>
      <div className="slide-page"><Pmis20060723Slide8 /></div>
      <div className="slide-page"><Pmis20060723Slide9 /></div>
