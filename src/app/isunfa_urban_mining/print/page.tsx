...
export default function UrbanMiningPrint() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`UrbanMining_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'UrbanMining_Slides_PNG.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-slate-100 min-h-screen">
      ...
      <div className="slide-page"><UrbanMiningSlide1 /></div>
      <div className="slide-page"><UrbanMiningSlide2 /></div>
      <div className="slide-page"><UrbanMiningSlide3 /></div>
      <div className="slide-page"><UrbanMiningSlide4 /></div>
      <div className="slide-page"><UrbanMiningSlide5 /></div>
      <div className="slide-page"><UrbanMiningSlide6 /></div>
      <div className="slide-page"><UrbanMiningSlide7 /></div>
      <div className="slide-page"><UrbanMiningSlide8 /></div>
      <div className="slide-page"><UrbanMiningSlide9 /></div>
    </div>
  );
}
