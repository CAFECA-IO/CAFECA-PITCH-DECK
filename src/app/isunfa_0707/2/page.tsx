      ...
      <div className="z-10 w-full max-w-6xl flex flex-col items-center px-16 relative">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-slate-500 leading-relaxed font-medium max-w-3xl mx-auto mt-4">
            <span className="text-orange-600 font-bold">碳盤查的目的是為了減碳。</span>傳統人工「耗時、易錯、難追溯」的痛點，已成為企業合規與轉型的最大瓶頸。唯有透過 AI，才能將靜態的歷史記錄，轉化為即時、精準的決策工具。
          </p>
        </div>

        {/* Info: (20260707 - Luphia) 4 Roles Grid */}
        <div className="grid grid-cols-4 gap-6 w-full">
          {/* Info: (20260707 - Luphia) Card 1 */}
