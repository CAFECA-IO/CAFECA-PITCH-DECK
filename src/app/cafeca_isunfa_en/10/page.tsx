  ...
  return (
    <div className="w-[1280px] h-[720px] bg-gradient-to-br from-[#060c15] via-[#0b1424] to-[#04080f] relative overflow-hidden shadow-2xl flex flex-col justify-between border border-slate-900/80 text-white font-sans">
      ...
      <div className="px-16 pt-10 relative z-10 flex justify-between items-start">
        <div>
          ...
          <h1 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300 leading-tight">
            Technical Barrier: AI Carbon Accountant — FAITH
          </h1>
        </div>
      ...
      <div className="flex-1 px-16 flex flex-col justify-center relative z-10 w-full max-w-5xl mx-auto pb-4 gap-4 mt-2">
        ...
        {/* Info: (20260609 - Luphia) Top: Description Banner */}
        <div className="bg-slate-950/60 border border-slate-800 p-5 rounded-2xl flex items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-slate-200 text-base">NVIDIA H100 Cluster Pre-training</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                Leveraged the national Taipei-1 supercomputer for core pre-training, fusing global corporate open data from 1990 to 2025.
              </p>
            </div>
          </div>
          <div className="text-right flex-shrink-0">
            <span className="text-[10px] text-slate-500 uppercase font-bold tracking-wider block">Core Moat</span>
            <span className="text-lg font-bold text-emerald-400">Process-Level Inference Expert</span>
          </div>
        </div>

        {/* Info: (20260609 - Luphia) Stacked Architecture */}
        <div className="space-y-4">

          {/* Info: (20260609 - Luphia) Layer 1: Specialist Modules */}
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-slate-950/40 border border-slate-800 p-4 rounded-xl flex items-center justify-between group hover:border-emerald-500/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-slate-200">Cross-Form Auto-Reconciliation Engine</span>
              </div>
            ...
            <div className="bg-slate-950/40 border border-slate-800 p-4 rounded-xl flex items-center justify-between group hover:border-emerald-500/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-slate-200">Physics Conservation & Stoichiometry Engine</span>
              </div>
              <span className="text-[10px] text-slate-500 uppercase tracking-widest font-mono">Physics Reasoning</span>
            </div>
          </div>

          {/* Info: (20260609 - Luphia) Layer 2: RAG DB */}
          <div className="bg-slate-950/60 border border-slate-800 p-5 rounded-xl">
            <div className="flex items-center gap-3 mb-3">
              <Database className="text-emerald-400" size={16} />
              <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Multimodal RAG Expert Knowledge Base & Training Domains</h4>
            </div>

            <div className="grid grid-cols-4 gap-2.5">
              {[
                "Financial Accounting", "Chemical Engineering",
                "Environmental Engineering", "IFRS / GAAP Standards",
                "Civil Engineering", "Materials Engineering",
                "Hydraulic Engineering", "Process Optimization Path"
              ].map((topic, i) => (
