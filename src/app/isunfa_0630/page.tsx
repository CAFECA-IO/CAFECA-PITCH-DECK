...
export default function CafecaFaithSlideBrowser() {
  ...
  // Info: (20260629 - Luphia) Dynamic scaling logic for mobile preview
  const [mobileScale, setMobileScale] = useState(0.3);

  useEffect(() => {
    const handleResize = () => {
      // Info: (20260629 - Luphia) Desktop Preview Scaling Calc
      ...
      // Info: (20260629 - Luphia) Mobile List Scaling Calc
  ...
  // Info: (20260629 - Luphia) Slide Components Mapping
  ...
  // Info: (20260629 - Luphia) Keyboard navigation
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 text-slate-800 overflow-hidden font-sans">
      ...
      {/* Info: (20260629 - Luphia) Universal Header */}
      <div className="h-14 border-b border-slate-200 flex items-center justify-between px-4 bg-white/80 backdrop-blur-md z-20 flex-shrink-0">
        ...
        {/* Info: (20260629 - Luphia) Desktop Controls */}
      ...
      {/* Info: (20260629 - Luphia) Mobile View */}
      <div
      ...
      {/* Info: (20260629 - Luphia) Desktop Layout */}
      <div className="hidden md:flex flex-1 overflow-hidden">
        <div className="flex-1 flex overflow-hidden">
          {/* Info: (20260629 - Luphia) Preview Area */}
          ...
          {/* Info: (20260629 - Luphia) Side Navigator */}
