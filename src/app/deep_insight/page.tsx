...
import DeepInsightSlide1 from '@/app/deep_insight/1/page';
import DeepInsightSlide2 from '@/app/deep_insight/2/page';
import DeepInsightSlide3 from '@/app/deep_insight/3/page';
import DeepInsightSlide4 from '@/app/deep_insight/4/page';
import DeepInsightSlide5 from '@/app/deep_insight/5/page';
import DeepInsightSlide6 from '@/app/deep_insight/6/page';
import DeepInsightSlide7 from '@/app/deep_insight/7/page';
import DeepInsightSlide8 from '@/app/deep_insight/8/page';
import DeepInsightSlide9 from '@/app/deep_insight/9/page';
import DeepInsightSlide10 from '@/app/deep_insight/10/page';
import DeepInsightSlide11 from '@/app/deep_insight/11/page';
import DeepInsightSlide12 from '@/app/deep_insight/12/page';
import DeepInsightSlide13 from '@/app/deep_insight/13/page';
import DeepInsightSlide14 from '@/app/deep_insight/14/page';
import DeepInsightSlide15 from '@/app/deep_insight/15/page';
import DeepInsightSlide16 from '@/app/deep_insight/16/page';
import DeepInsightSlide17 from '@/app/deep_insight/17/page';
import DeepInsightSlide18 from '@/app/deep_insight/18/page';
import DeepInsightSlide19 from '@/app/deep_insight/19/page';
import DeepInsightSlide20 from '@/app/deep_insight/20/page';
import DeepInsightSlide21 from '@/app/deep_insight/21/page';
    ...
    <div className="flex flex-col h-screen bg-neutral-900 text-white overflow-hidden">
      ...
      <div className="h-14 border-b border-neutral-800 flex items-center justify-between px-4 bg-neutral-900 z-20 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          <Link href="/deep_insight/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/deep_insight/${currentSlide}`} target="_blank" className="hidden md:block">
