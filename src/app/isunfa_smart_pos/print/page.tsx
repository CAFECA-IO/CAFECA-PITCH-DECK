...
export default function ISunFAPOSPrint() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`iSunFA_POS_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'iSunFA_POS_Slides_PNG.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-neutral-950 min-h-screen">
      ...
      <div className="slide-page"><ISunFASlide14 /></div>
      <div className="slide-page"><ISunFASlide15 /></div>
      <div className="slide-page"><ISunFASlide16 /></div>
      <div className="slide-page"><ISunFASlide17 /></div>
      <div className="slide-page"><ISunFASlide18 /></div>
      <div className="slide-page"><ISunFASlide19 /></div>
      <div className="slide-page"><ISunFASlide20 /></div>
    </div>
  );
}
