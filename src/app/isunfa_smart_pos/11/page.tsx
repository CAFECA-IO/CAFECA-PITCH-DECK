...
export default function Slide6() {
  const productFacts = [
    { label: '碳足跡', value: '1.2', unit: 'kg CO2e' },
    { label: '回收材質', value: '45', unit: '%' },
    { label: '生產水耗', value: '30', unit: 'L' },
    { label: '產地', value: '台灣', unit: '' },
    { label: '可回收性', value: '100', unit: '%' },
    { label: '勞工權益評分', value: '98', unit: '/100' },
    { label: '能源效率', value: 'A+', unit: '級' },
    { label: '有機棉', value: '100', unit: '%' },
  ];
