...
export default function IsuncloudWeeklyReportPrint() {
    ...
    try {
      for (let i = 0; i < slidePages.length; i++) {
        ...
        if (target) {
          ...
          zip.file(`IsuncloudWeeklyReport_Slide_${(i + 1).toString().padStart(2, '0')}.png`, base64, { base64: true });
        }
      ...
      a.href = url;
      a.download = 'IsuncloudWeeklyReport_Slides_PNG.zip';
      a.click();
  ...
  return (
    <div className="print-container bg-white min-h-screen">
      ...
      <div className="slide-page"><IsuncloudWeeklyReportSlide1 /></div>
      <div className="slide-page"><IsuncloudWeeklyReportSlide2 /></div>
