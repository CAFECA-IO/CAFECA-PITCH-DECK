...
import IsuncloudWeeklyReportSlide1 from '@/app/isuncloud_weekly_report/1/page';
import IsuncloudWeeklyReportSlide2 from '@/app/isuncloud_weekly_report/2/page';

export default function IsuncloudWeeklyReportSlideBrowser() {
  ...
  const SlideComponents: { [key: number]: React.ComponentType } = {
    1: IsuncloudWeeklyReportSlide1,
    2: IsuncloudWeeklyReportSlide2,  };

  const CurrentSlideComponent = SlideComponents[currentSlide];

  const slideTitles: { [key: number]: string } = {
    1: 'Cover: iSunCloud Weekly Report',
    ...
    <div className="flex flex-col h-screen bg-neutral-900 text-white overflow-hidden">
      ...
      <div className="h-14 border-b border-neutral-800 flex items-center justify-between px-4 bg-neutral-900 z-20 flex-shrink-0">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <div>
            <h1 className="text-sm font-bold text-gray-200">iSunCloud Weekly Report Presentation</h1>
        ...
        <div className="flex items-center gap-3">
          <Link href="/isuncloud_weekly_report/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/isuncloud_weekly_report/${currentSlide}`} target="_blank" className="hidden md:block">
