...
import ISunFASlide1 from '@/app/isunfa_newtaipei_env/1/page';
import ISunFASlide2 from '@/app/isunfa_newtaipei_env/2/page';
import ISunFASlide3 from '@/app/isunfa_newtaipei_env/3/page';
import ISunFASlide4 from '@/app/isunfa_newtaipei_env/4/page';
import ISunFASlide5 from '@/app/isunfa_newtaipei_env/5/page';
import ISunFASlide6 from '@/app/isunfa_newtaipei_env/6/page';
import ISunFASlide7 from '@/app/isunfa_newtaipei_env/7/page';
import ISunFASlide8 from '@/app/isunfa_newtaipei_env/8/page';
import ISunFASlide9 from '@/app/isunfa_newtaipei_env/9/page';
import ISunFASlide10 from '@/app/isunfa_newtaipei_env/10/page';
import ISunFASlide11 from '@/app/isunfa_newtaipei_env/11/page';
import ISunFASlide12 from '@/app/isunfa_newtaipei_env/12/page';
    ...
    <div className="flex flex-col h-screen bg-neutral-900 text-white overflow-hidden">
      ...
      <div className="h-14 border-b border-neutral-800 flex items-center justify-between px-4 bg-neutral-900 z-20 flex-shrink-0">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <div>
            <h1 className="text-sm font-bold text-gray-200">iSunFA 新北淨零治理</h1>
        ...
        <div className="flex items-center gap-3">
          <Link href="/isunfa_newtaipei_env/print" target="_blank" className="hidden md:block">
          ...
          <Link href={`/isunfa_newtaipei_env/${currentSlide}`} target="_blank" className="hidden md:block">
