          ...
          <div className="flex-1 w-full max-w-5xl mx-auto flex flex-col justify-center gap-2 mt-2">
            ...
            {[
              ...
              <div key={i} className="grid grid-cols-[1fr_2fr_2fr] gap-4 items-stretch">
                {/* Info: (20260505 - Luphia) Dimension */}
